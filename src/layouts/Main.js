      ...
      <Router>
        ...
        <ContentBody>
          <Switch>
            ...
            <Route
              exact
              path="/content-single/:cat_id"
              component={NewContentSingle}
            />
            <Route
              exact
              path="/content-chapter/:cat_id"
              component={NewContentChapter}
            />
            <Route
              exact
              path="/edit-single/:id"
              component={EditContentSingle}
            />
            <Route
              exact
              path="/edit-chapter/:id"
              component={EditContentChapter}
            />
          </Switch>
        </ContentBody>
      </Router>
